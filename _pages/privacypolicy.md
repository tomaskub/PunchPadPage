...
- __Application__ refers to Punch-Pad, the software program provided by the Company.



- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Punch-Pad.
...
We do not collect any personal data. Data you generate and save are hosted only on your device and we have no access to it.
...
- By email: tomasz.m.kubiak@icloud.com
